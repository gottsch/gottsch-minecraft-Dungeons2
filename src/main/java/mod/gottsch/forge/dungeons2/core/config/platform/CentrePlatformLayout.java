...
/** One platform at the room's centre. Ignores {@code size} -- there is one of it wherever the room's middle is. */
public record CentrePlatformLayout(int inset) implements PlatformLayoutPattern {

    public static final String NAME = "centre";

    public CentrePlatformLayout() {
        this(PlatformLayoutPattern.DEFAULT_INSET);
    }

    public static final MapCodec<CentrePlatformLayout> CODEC =
            PlatformLayoutPattern.INSET(CentrePlatformLayout::new, CentrePlatformLayout::inset);
