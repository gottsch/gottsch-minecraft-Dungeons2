...
//	public static Boolean enableVanillaSpawners;
//	public static Boolean enableOneTimeSpawners;
//	public static Boolean enableBossSpawners;
	...
	public static void initialize(File file) {
       ...
       // logging
        ...
        config.setCategoryComment("03-dungeons", "General Dungeons2! mod properties.");        
        enableDungeons = config.getBoolean("enableDungeons", "03-dungeons", true, "Enable/disable the generation of dungeons.");
...
//        enableVanillaSpawners = config.getBoolean("enableVanillaSpawners", "04-dungeon-gen", true, "Enable/disable the generation of vanilla spawners in dungeons.");
//        enableOneTimeSpawners = config.getBoolean("enableOneTimeSpawners", "04-dungeon-gen", true, "Enable/disable the generation of one-time spawners in dungeons.\n" +
//        "One-time spawners are a special spawner that spawns its mobs once and then is removed. They are not displayed in game.");
//        enableBossSpawners = config.getBoolean("enableBossSpawners", "04-dungeon-gen", true, "Enable/disable the generation of boss spawners in dungeons.\n" +
//        "Boss spawners are special one-time spawners that spawn a boss mob in special locatoins.");
